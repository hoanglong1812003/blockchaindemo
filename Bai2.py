...
# Giả sử ai đó thay đổi dữ liệu của block thứ 2, trong python mặc định thứ tự đầu tiên là 0.
blockchain.chain[1].data = "Anime Girl" # Thay đổi dữ liệu của block thứ 2
